...
<body>
    ...
    <main>
        <h1>Calculadora de tempo</h1>
            ...
            <label for="seg">Qual foi o total de segundos?</label>
    ...
    <section>
        ...
        <p>Analisando o valor que você diguitou, <strong><?=number_format($total, 0, ",", ".")?> segundos</strong> equivalem a um total de:</p>
        <ul>
